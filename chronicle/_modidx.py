...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'chronicle.core': { 'chronicle.core.ChronicleLogs': ('core.html#chroniclelogs', 'chronicle/core.py'),
            ...
            'chronicle.read': { 'chronicle.read.read_chronicle': ('read.html#read_chronicle', 'chronicle/read.py'),
                                'chronicle.read.read_chronicle_logs': ('read.html#read_chronicle_logs', 'chronicle/read.py'),
                                'chronicle.read.read_chronicle_metrics': ('read.html#read_chronicle_metrics', 'chronicle/read.py')}}}
