...
# %% auto 0
__all__ = ['read_chronicle_metrics', 'read_chronicle_logs', 'ChronicleMetrics', 'ChronicleLogs']
...
def read_chronicle_metrics(
    ...
    return read_chronicle(path, "metrics", version) 
...
def read_chronicle_logs(
    ...
    return read_chronicle(path, "logs", version) 
